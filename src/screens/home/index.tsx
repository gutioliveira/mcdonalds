...
const menus = [
  {
     ...
     "items":[
        ...
        {
           "name":"Hot Tea",
           "description":"McDonald's Hot Tea has a robust black tea flavor with hints of floral and orange notes",
           "price":1.89,
        ...
        {
           "name":"Dr Pepper®",
           "description":"McDonald's serves Dr Pepper, the classic and refreshing fountain drink with a unique blend of 23 flavors",
           "price":1.89,
        ...
        },
        {
           ...
           "description":"The McDonald’s Mango Pineapple Smoothie recipe features the sweet combination of fruit juices and purees such as mango and pineapple, blended with creamy low fat yogurt and ice",
           "price":3,
  ...
  },
  {
     ...
     "items":[
        ...
        },
        {
           ...
           "description":"McDonald's Sausage McMuffin® recipe features a warm, freshly toasted English muffin, topped with a savory hot sausage patty and a slice of melty American cheese",
           "price":2.89,
        ...
        },
        {
           ...
           "description":"McDonald’s Sausage Biscuit is the perfect sausage breakfast sandwich, made with sizzling hot sausage on a warm buttermilk biscuit that’s topped with real butter and baked to perfection",
           "price":2.89,
        ...
        },
        {
           ...
           "description":"Sausage, Egg & Cheese McGriddles® feature soft, warm griddle cakes—with the sweet taste of maple—that hold a fluffy folded egg, savory sausage, and melty American cheese.",
           "price":3.89,
     ...
     "items":[
        {
           ...
           "description":"Hamburger, World Famous Fries® (Kids), 1% Low Fat Milk Jug, Apple Slices",
           "price":2.49,
        ...
        },
        {
           ...
           "description":"6 Piece Chicken McNuggets® (6 piece), World Famous Fries® (Kids), 1% Low Fat Milk Jug, Apple Slices",
           "price":3.29,
  ...
  },
  {
     ...
     "items":[
        ...
        },
        {
           ...
           "description":"Try the McDonald’s Chocolate Shake, the perfect sweet treat for any time of the day. Our chocolate shake is made with delicious soft serve, chocolate syrup and finished off with a creamy whipped topping",
           "price":3,
        ...
        },
        {
           ...
           "description":"McDonald's Strawberry Shake is made with creamy vanilla soft serve, blended with strawberry syrup and topped with whipped topping",
           "price":3,
        ...
        {
           "name":"Vanilla Shake",
           "description":"McDonald's vanilla shake is made with our creamy vanilla soft serve and topped with whipped topping for a cool, tasty treat",
           "price":3,
